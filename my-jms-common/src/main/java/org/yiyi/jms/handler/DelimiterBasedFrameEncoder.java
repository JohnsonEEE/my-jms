 ...
 * @date 2021.07.05
 */
public class DelimiterBasedFrameEncoder extends ChannelOutboundHandlerAdapter {
    ...
    public void write (ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        try {
            byte[] bytes = (byte[]) msg;
            byte[] delBytes = delimiter.getBytes(StandardCharsets.UTF_8);
            byteBuf = ctx.alloc ().ioBuffer (bytes.length + delBytes.length);
            byteBuf.writeBytes (bytes).writeBytes (delBytes);
